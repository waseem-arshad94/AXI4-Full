...
#
# Generated by export_simulation on Sat May 25 13:00:20 PKT 2024
#
################################################################################
...
'-reset_run' switch to the './axi4_bd.sh' script.

./axi4_bd.sh -reset_run
...
./axi4_bd.sh -noclean_files

For more information on the script, please type './axi4_bd.sh -help'.
